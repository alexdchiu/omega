...
class Property(TimeStampedUUIDModel):
  ...
  property_number = models.IntegerField(verbose_name=_('Property Number'), validators=[MinValueValidator(1)],default=111)
  price = models.DecimalField(verbose_name=_('Price'), max_digits=15, decimal_places=2, default=0.00)
  tax = models.DecimalField(verbose_name=_('Property Tax'), max_digits=6, decimal_places=4, default=0.15, help_text='15% property tax charged')
  plot_area = models.DecimalField(verbose_name=_('Land Area (acres)'), max_digits=8, decimal_places=2, default=0.0)
