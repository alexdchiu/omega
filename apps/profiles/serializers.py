...
class ProfileSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = Profile
    fields = ['username', 'first_name', 'last_name', 'full_name', 'email', 'id', 'phone_number', 'profile_photo', 'about_me', 'license', 'country', 'city', 'is_buyer', 'is_seller', 'is_agent', 'rating', 'num_reviews', 'reviews']
