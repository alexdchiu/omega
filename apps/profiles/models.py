...
class Profile(TimeStampedUUIDModel):
  ...
  phone_number = PhoneNumberField(verbose_name=_('Phone Number'), max_length=30, default='+12122000000')
  ...
  country = CountryField(verbose_name=_('Country'), default='United States of America', blank=False, null=False)
